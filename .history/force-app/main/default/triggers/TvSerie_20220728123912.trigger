trigger TvSerie on Tv_Serie__c (before insert , after insert) {
   ...
   // if(Trigger.isAfter){
    ...
    String[] toAddresses = new String[] {'piotr.lobejko@accenture.com', 'marcin.skladanowski@accenture.com','piotrek3334@gmail.com', 'prounaucrisudou-6411@yopmail.com'};
    mail.setToAddresses(toAddresses);
    mail.setReplyTo('piotr.lobejko@accenture.com');
    mail.setSubject('blatriger');
